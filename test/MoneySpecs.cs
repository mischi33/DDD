...
namespace DDDSpecs.Tests
{
    public class MoneySpecs
    {
        ...
        [Fact]
        public void Two_money_instances_equal_if_contain_the_same_amount_of_money()
        {
            Money money1 = new Money(1, 2, 3, 4, 5, 6);
            Money money2 = new Money(1, 2, 3, 4, 5, 6);
        ...
        [Fact]
        public void Two_money_instances_do_not_equal_if_contain_different_amount_of_money()
        {
            Money dollar = new Money(0, 0, 0, 1, 0, 0);
            Money hundretCents = new Money(100, 0, 0, 0, 0, 0);

            dollar.Should().NotBe(hundretCents);
            dollar.GetHashCode().Should().NotBe(hundretCents.GetHashCode());
        }
        ...
        [Fact]
        public void Cannot_substraction_more_than_exists()
        {
